...
class AppTheme {
  ...
  static const green = Color(0xFF188B87);
  static const plantation = Color(0xFF244D49);
  static const pinkDown = Color(0xFFF3E9E5);
  static const pinkUp = Color(0xFFE2BE5B);
  static const cherryWood = Color(0xFF651A14);
